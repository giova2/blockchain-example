...
*/
BlockChain.prototype.createNewBlock = function ({nonce, previousBlockHash, hash} : CreateNewBlockArguments) {
  const newBlock = {
 ...
 * @returns 
 */
BlockChain.prototype.createNewTransaction = function ({amount, sender, recipient} : CreateNewTransactionArguments) : Transaction {
 ...
 * @returns 
 */
BlockChain.prototype.addTransactionToPendingTransactions = function(transactionObj:Transaction){
